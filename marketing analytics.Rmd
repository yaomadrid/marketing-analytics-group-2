...
#Then we assign "Loan_Approval=1" when "loan is originated" or "application is approved but not accepted" and assign "Loan_Approval= 0" when "application is denied” s
...
#under 5% significant level, we can reject the null hypothesis and think that there is a significant difference between two means#
