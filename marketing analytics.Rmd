...
For msamd and edit_status, as there are  we replaced the missing value with 0 and created a new dummy variable
...
```{r}
loan_approval_model1<-glm(Loan_Approval~loan_amount_000s+hud_median_family_income+factor(applicant_sex)+factor(applicant_race_1), family = binomial(link = 'logit'),data=ny_hmApproval)
